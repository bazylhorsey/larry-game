...
function Player:update(dt)
    ...
    if self.map:tileAt(self.x, self.y + 1).id == FLAG or self.map:tileAt(self.x, self.y - 1).id == FLAG or
    self.map:tileAt(self.x, self.y + 2).id == FLAG or self.map:tileAt(self.x, self.y - 2).id == FLAG then
